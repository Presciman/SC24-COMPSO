...
def parse_args():
    ...
    #Baixi add errorbound
    parser.add_argument('--error_bound', type=str, default=str(1),
                        help='error bound for lossy compression')
    args = parser.parse_args()
    
    #Baixi set environment variables
    os.environ['ERROR_BOUND']=args.error_bound
...
def main():
    ...
    for epoch in range(args.resume_from_epoch + 1, args.epochs + 1):
        #os.environ['EPOCHS'] = str(epoch)#baixi
